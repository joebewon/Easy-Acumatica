...
export interface QueryOptionsConfig {
    ...
    /** (Optional) The fields to order by. The Acumatica Devs seemed to missed this option when writing their docs. {@link https://www.odata.org/getting-started/basic-tutorial/#orderby OData Docs for $orderby}. */
