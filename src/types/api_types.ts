 ...
 * 
 * @param { string | Filter } $filter `string | Filter` (Optional) A Filter object defining the OData filter paramter. {@link https://help.acumatica.com/(W(5))/Help?ScreenId=ShowWiki&pageid=f279ec05-2f71-4376-a76f-d3ed0e0e2556 Acumatica Docs for $filter}.
 * @param { number } $top `number` (Optional) The number of rows to get. {@link https://help.acumatica.com/(W(5))/Help?ScreenId=ShowWiki&pageid=12ecc8c7-b0c0-4f26-bfe5-388be9674374 Acumatica Docs for $top}.
 ...
 * @param { string[] } $expand `string[]` (Optional) The list of linked and detail entities to expand. {@link https://help.acumatica.com/(W(5))/Help?ScreenId=ShowWiki&pageid=b6c2fecd-0b2e-4aba-9bad-4c5050befe25 Acumatica Docs for $expand}.
 * @param { string[] } $select `string[]` (Optional) The list of fields to return. {@link https://help.acumatica.com/(W(5))/Help?ScreenId=ShowWiki&pageid=ecbfdb12-4853-4ff5-b8c5-eade02f9b47b Acumatica Docs for $select}.
 */
export interface QueryOptionsConfig {
    /** (Optional) A Filter object defining the OData filter paramter. {@link https://help.acumatica.com/(W(5))/Help?ScreenId=ShowWiki&pageid=f279ec05-2f71-4376-a76f-d3ed0e0e2556 Acumatica Docs for $filter}. */
    $filter?: string | Filter ;
    
    /** (Optional) The number of rows to get. {@link https://help.acumatica.com/(W(5))/Help?ScreenId=ShowWiki&pageid=12ecc8c7-b0c0-4f26-bfe5-388be9674374 Acumatica Docs for $top}. */
    $top?: number;
